      ...
      <div className="space-y-8">
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            By accessing and using GhostScribe ("the Service"), you agree to be
            bound by these Terms of Service ("Terms"). If you do not agree to
            these Terms, please do not use our Service. These Terms apply to all
            users of the Service, including without limitation users who are
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div className="space-y-3 text-gray-300">
            <p>
              GhostScribe is an AI-powered content generation platform that
              helps users create marketing content for various social media
            ...
            <ul className="space-y-2 ml-4">
              <li className="flex items-start gap-2">
                ...
                <span>
                  AI-assisted content generation for LinkedIn, Twitter, and
                  Threads
                </span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div className="space-y-4 text-gray-300">
            <p>As a user of GhostScribe, you agree to:</p>
          ...
          <div className="space-y-3 text-gray-300">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Generate content that is illegal, harmful, threatening, or
                  abusive
                </span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                <span className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></span>
                <span>
                  Violate the rights of others, including privacy and
          ...
          <div className="space-y-4 text-gray-300">
            <div>
              ...
              <p>
                ...
                GhostScribe and its licensors. The Service is protected by
            ...
            <div>
              ...
              <p>
                ...
                Service. However, by using our Service, you grant us a limited,
                non-exclusive, royalty-free license to use, process, and analyze
            ...
            <div>
              ...
              <p>
                Content generated by our AI is provided for your use. You are
                responsible for reviewing, editing, and ensuring compliance with
                applicable laws before publishing. We do not claim ownership of
                AI-generated content, but you acknowledge that such content may
                be similar to content generated for other users.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-3 text-gray-300">
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="w-2 h-2 rounded-full bg-white/40 mt-2 flex-shrink-0"></span>
                <span>
                  Free trial includes limited usage as specified in your account
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-2 h-2 rounded-full bg-white/40 mt-2 flex-shrink-0"></span>
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div className="space-y-3 text-gray-300">
            <p>
              In no event shall GhostScribe, its directors, employees, partners,
            ...
            <p>
              Our total liability to you for any cause of action whatsoever, and
              regardless of the form of the action, will at all times be limited
              to the amount paid, if any, by you to us for the service during
              the preceding month.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <p className="text-gray-300">
            ...
            effect. Your continued use of the service after such modifications
