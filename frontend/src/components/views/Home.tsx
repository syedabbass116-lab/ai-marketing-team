      ...
      <main className="relative z-10 flex flex-col items-center justify-start pt-12 md:pt-28 px-4 animate-in fade-in duration-700 slide-in-from-bottom-4">
        <div className="text-center space-y-5 mb-14">
          <div className="relative inline-block mb-2">
            ...
            <img
              src={logo}
              alt="GhostScribe"
              className="relative w-20 h-20 object-contain mx-auto opacity-90 drop-shadow-[0_0_15px_rgba(255,255,255,0.15)]"
            />
          </div>
          <h1
            className="text-4xl md:text-5xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-[#888]"
            style={{ fontFamily: "Montserrat, sans-serif" }}
          >
            Hii {capitalizedFirstName}, what would you like to post today?
          </h1>
          <p
            className="text-sm md:text-base text-[#666] font-medium max-w-md mx-auto"
            style={{ fontFamily: "Poppins, sans-serif" }}
          >
            Your content engine is fully operational. Select an action to begin
            crafting.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full max-w-[500px]">
          ...
          >
            ...
            <h3
              className="text-lg font-semibold text-[#f0f0f0] mb-2 tracking-tight relative z-10"
              style={{ fontFamily: "Montserrat, sans-serif" }}
            >
              Generate a post
            </h3>
            <p
              className="text-xs text-[#888] leading-relaxed relative z-10"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
          ...
          <div className="p-6 bg-[#0a0a0a] border border-[#1f1f1f] rounded-2xl flex flex-col gap-4 relative overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center gap-2">
                ...
                <span
                  className="text-[10px] font-bold text-[#888] tracking-widest uppercase"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  Live AI Engine
                </span>
            ...
            <p
              className="text-xs text-[#777] leading-relaxed mb-1"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
              GhostScribe automatically structures your thoughts into
            ...
            <div className="bg-[#050505] border border-[#1a1a1a] rounded-xl font-mono text-xs text-[#888] h-[160px] overflow-hidden relative shadow-inner">
              <div className="flex items-center gap-1.5 px-3 py-2 border-b border-[#1a1a1a] bg-[#0a0a0a]">
                ...
                <div className="w-2.5 h-2.5 rounded-full bg-[#333]" />
                <div className="w-2.5 h-2.5 rounded-full bg-[#333]" />
                <span className="ml-2 text-[9px] uppercase tracking-widest text-[#555]">
                  ai_engine.sh
                </span>
              </div>
              <div className="p-4">
                <span className="whitespace-pre-wrap leading-relaxed text-[#a0a0a0]">
                  {typedText}
                </span>
        ...
        <div className="w-full max-w-[500px] mt-12 space-y-6">
          ...
          {!hasWorkspaces && (
            <p
              className="text-center text-xs text-[#2e2e2e]"
              style={{ fontFamily: "Poppins, sans-serif" }}
            >
